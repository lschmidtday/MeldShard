...
#[derive(Debug)]
pub struct MeldShardProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MeldShardProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MeldShard processing");
    
    let mut processor = MeldShardProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MeldShardProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MeldShardProcessor::new(false);
